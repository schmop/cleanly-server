 ...
 */
final class Version20220717210812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE todo DROP weight');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE todo ADD weight INT NOT NULL');
