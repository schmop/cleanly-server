 ...
 */
final class Version20220727233137 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE device (id VARCHAR(255) NOT NULL, user_id INT NOT NULL, push_id VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
