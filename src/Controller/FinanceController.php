...
class FinanceController extends UserAwareController
{
    ...
    public function addTransaction(
        ...
        } catch (AccessDeniedException | PersistenceException | \LogicException | \TypeError | \ValueError $e) {
            return JsonErrorResponse::fromException($logger, $e, 'Failed to add transaction');
        }
    }
    ...
    public function deleteTransaction(
        ...
        try {
            ...
            return JsonErrorResponse::fromException($logger, $e, 'Failed to delete transaction');
        }
    }
    ...
    public function updateTransaction(
        ...
        try {
            ...
            return JsonErrorResponse::fromException($logger, $e, 'Failed to update transaction');
        }
    }
    ...
    public function getTransactions(
        ...
        try {
            ...
            return JsonErrorResponse::fromException($logger, $e, 'Failed to load transactions');
        }
    }
    ...
    public function getFinanceSummary(
        ...
        } catch (AccessDeniedException | NoResultException | NonUniqueResultException | \LogicException | \RuntimeException $e) {
            return JsonErrorResponse::fromException($logger, $e, 'Failed to load finance summary');
        }
    }
}
